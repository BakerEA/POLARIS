...
import sys
import POLARIS_function_pathway as f
import pandas as pd
import numpy as np
...
if rank==0:
    ...
    data['SNP'].to_csv(filename, header=False, index=None, sep='\t')
